-- models/staging/stg_history_day.sql
...
with raw as (
  select * from {{ source('climate_data_for_bi','history_day') }}
)

select
  postal_code::varchar                             as postal_code,
  date_valid_std::date                             as observation_date,
  ...
  tot_snowfall_in::numeric(6,2)                    as total_snow_in,
  min_temperature_wetbulb_2m_f::numeric(5,1)       as min_wetbulb_temp_f,
